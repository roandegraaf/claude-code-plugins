...
3. Orient in the code the remaining work touches. Fan out read-only Explore subagents in parallel when several distinct areas need scouting; save your own context for planning. (No Agent tool offered? You're at the nesting limit — scout yourself.)
